...
print(f"📉 Min of mean_video_similarity: {np.min(valid_mean_video_sims):.4f}" if valid_mean_video_sims else "No valid min_video_similarity")
print(f"📈 Max of mean_video_similarity: {np.max(valid_mean_video_sims):.4f}" if valid_mean_video_sims else "No valid max_video_similarity")
